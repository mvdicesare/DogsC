...
## Part Three: Collection View Controller, Collection View Cell, and Detail View Controller
...
* Make a `UIViewController`, be sure to change the language to swift.
* Create your bridging header and import the necessary files.
* Create your IBOutlets.
* Create a landing pad for a URLString, breed and subBreed.
* Make the `UIViewController` display the selected dog image and the name of the breed + subBreed if applicable.
